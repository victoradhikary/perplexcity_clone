...
const SearchBar = ({ onSearch, className = "", placeholder = "Ask anything..." }: SearchBarProps) => {
  ...
  return (
    <form onSubmit={handleSubmit} className={`${className}`}>
      <div className="search-bar flex items-center px-3 sm:px-4 py-2 sm:py-3">
        ...
        <div className="flex items-center gap-1 sm:gap-2 ml-2">
          <button type="button" className="p-1.5 sm:p-2 hover:bg-perplexity-bg-lighter rounded-lg hidden sm:block">
          ...
          <button
            type="submit"
            className="p-1.5 sm:p-2 bg-perplexity hover:bg-perplexity-dark rounded-lg text-white"
          >
